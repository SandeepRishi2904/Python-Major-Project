...
file = pathlib.Path('C:\\Users\\jbsan\\OneDrive\\Desktop\\Attendance.xlsx')
if file.exists():
    pass
else:
    file=Workbook()
    ...
    file.save("C:\\Users\\jbsan\\OneDrive\\Desktop\\Attendance.xlsx")
...
#Reg no
def reg_no():
    file=openpyxl.load_workbook('C:\\Users\\jbsan\\OneDrive\\Desktop\\Attendance.xlsx')
    sheet=file.active
    row=sheet.max_row
...
def Clear():
    ...
    img1=PhotoImage(file="C:\\Users\\jbsan\\OneDrive\\Desktop\\image upload.png")
...
def Save():
    ...
    if N1=="" or C1=="Select Class" or D2=="" or Re1=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
        ...
        file.save(r'C:\\Users\\jbsan\\OneDrive\\Desktop\\Attendance.xlsx')

        try:
            img.save("C:\\Users\\jbsan\\OneDrive\\Desktop\\Student Images/"+str(R1)+".jpg")
        except:
            messagebox.showinfo("info","Profile pic is not available!")
...
#top frames
Label(root,text="Email: jbsandeeprishi@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
Label(root,text="STUDENT'S REGISTRATION",width=10,height=2,bg="#c36464",fg="#fff",font='arial 20 bold').pack(side=TOP,fill=X)

#search box to update
Search=StringVar()
Entry(root,textvariable=Search,width=15,bd=2,font="arial 20").place(x=820,y=70)
imageicon3=PhotoImage(file="C:\\Users\\jbsan\\OneDrive\\Desktop\\search image.png")
Srch=Button(root,text="Search",compound=LEFT,image=imageicon3,width=123,bd=2,bg='#68ddfa',font="arial 15 bold",command=search)
Srch.place(x=1060,y=70)

imageicon4=PhotoImage(file="C:\\Users\\jbsan\\OneDrive\\Desktop\\images.png")
...
f_entry.place(x=200,y=50)

Father_Occupation=StringVar()
FO_entry=Entry(obj2,textvariable=Father_Occupation,width=20,font='arial 10')
FO_entry.place(x=200,y=100)
...
m_entry.place(x=670,y=50)

Mother_Occupation=StringVar()
MO_entry=Entry(obj2,textvariable=Mother_Occupation,width=20,font='arial 10')
MO_entry.place(x=670,y=100)

#image
f=Frame(root,bd=3,bg="black",width=200,height=200,relief=GROOVE)
f.place(x=1000,y=150)

img=PhotoImage(file="C:\\Users\\jbsan\\OneDrive\\Desktop\\image upload.png")
